...
const select_dog = document.querySelector(`#dog_select`);
const select_sub_dog = document.querySelector(`#sub_dog_select`);
const displayDiv = document.querySelector(`.display_image_dog`);
...
//     for (p in lista_poze_sub_dogs) {
//       if (selectedOption.value != 0) {
//         displayDiv.innerHTML = `<img class="display_image_dog" src="${lista_poze_sub_dogs[p]}" alt="${p}">`;
//       }
//     }
//   }
// }
